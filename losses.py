"""
Author: Quanhao Guo (https://github.com/GuoQuanhao)
Date: Aug 17, 2021
"""
...
class SupConLoss(nn.Layer):
    ...
    def forward(self, features, labels=None, mask=None):
        ...
        contrast_feature = paddle.concat(paddle.unbind(features, axis=1), axis=0)
        ...
        logits_mask = paddle.scatter(
            ...
            1,
            paddle.arange(batch_size * anchor_count).reshape([-1, 1]),
            0
        )
        '''
        logits_mask = paddle.ones_like(mask) - paddle.eye(mask.shape[0])
